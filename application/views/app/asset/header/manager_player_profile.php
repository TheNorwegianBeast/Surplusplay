...
<div class="mp-user-logo">
    <a href="<?php echo base_url(); ?>app_controller/User_profile/manager_profile">
        <img src="<?php echo base_url(); ?>application/views/app/asset/header/icons/user_active.png" alt="" height="100%" width="100%" />
    </a>
</div>
<div class="mp-user-txt">
    <a class="tooltips-profile"><label><?php echo $this->session->userdata('first_name') . " " . $this->session->userdata('last_name'); ?></label>
   <span>Profile</span>
    </a>
</div>
