                        ...
                        <div class="right-side">
                            <div class="login-section">
                                ...
                                <div class="new-pass-error">
                                    <div class="otp-incorrect" style="display: block;">
                                        <label><?php echo $this->session->flashdata('pass_message'); ?></label>
                                    </div>
                                </div>
                                ...
                                <div class="pass-error-row">
                                    <!-- Password correct -->
                                    <!-- <div class="pass-correct">
                                        <i class="fa fa-check correct-icon" aria-hidden="true"></i>
                                        <span class="opt-match">Password Match.</span>
                                    </div> -->
                                    <!-- Password incorrect -->

                                    <div class="otp-incorrect" style="display: block;">
                                    <!-- <i class="fa fa-times correct-icon" aria-hidden="true"></i> -->
                                        <span><?php echo $this->session->flashdata('con_message'); ?></span>
                                    </div>
                                ...
                                <div class="btn-resend-pwd">
                                    <input type="submit" class="resend-email" name="reset_pass" value="Reset Password">
                                </div>
